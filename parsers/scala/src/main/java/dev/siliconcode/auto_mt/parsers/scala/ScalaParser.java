...
public class ScalaParser extends Parser {
	...
	public static class Guard_Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ScalaVisitor ) return ((ScalaVisitor<? extends T>)visitor).visitGuard_(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Def_Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ScalaVisitor ) return ((ScalaVisitor<? extends T>)visitor).visitDef_(this);
			else return visitor.visitChildren(this);
		}
	}
