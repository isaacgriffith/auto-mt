...
package dev.siliconcode.auto_mt.parsers.scala;
...
public interface ScalaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ScalaParser#args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgs(ScalaParser.ArgsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ScalaParser#guard_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGuard_(ScalaParser.Guard_Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ScalaParser#def_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDef_(ScalaParser.Def_Context ctx);
	/**
