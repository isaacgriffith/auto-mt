...
package dev.siliconcode.auto_mt.parsers.java;
...
public class Java20Parser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Java20ParserVisitor ) return ((Java20ParserVisitor<? extends T>)visitor).visitStart(this);
	...
	public static class EmptyStatementContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Java20ParserVisitor ) return ((Java20ParserVisitor<? extends T>)visitor).visitEmptyStatement(this);
			else return visitor.visitChildren(this);
		}
	}
